...
- [`trace-replay-bug-fixing`](https://github.com/OpenGGF/OpenGGF/blob/develop/.claude/skills/trace-replay-bug-fixing/skill) — the
  canonical workflow for any `*TraceReplay` test failure.
- [`s1-trace-replay`](https://github.com/OpenGGF/OpenGGF/tree/develop/.claude/skills/s1-trace-replay/) — Sonic 1 trace recording
  specifics.
- [`s1-retro-trace`](https://github.com/OpenGGF/OpenGGF/tree/develop/.claude/skills/s1-retro-trace/) — recording S1 traces using
