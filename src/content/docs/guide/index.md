...
- [README](/README) -- Project overview and FAQ
- [CHANGELOG](/CHANGELOG) -- Detailed release history
- [ROADMAP](/ROADMAP) -- Development priorities
- [CONFIGURATION](/CONFIGURATION) -- Full configuration reference (all keys)
- [CREDITS](/CREDITS) -- Community resources this project builds on
- [OBJECT_CHECKLIST](/OBJECT_CHECKLIST) -- Sonic 2 object implementation status
- [S1_OBJECT_CHECKLIST](/S1_OBJECT_CHECKLIST) -- Sonic 1 object implementation status
- [S3K_OBJECT_CHECKLIST](/S3K_OBJECT_CHECKLIST) -- Sonic 3&K object implementation status
